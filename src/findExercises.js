...
export const getStudentByName = (fullName) => {
    ...
    return students.find((student)=> student.firstName.toUpperCase() === firstName.toUpperCase() && student.lastName.toUpperCase() === lastName.toUpperCase())
}
...
export const getInstructorOfStudent = (studentId) => {
    let pullFullStudent = students.find((student) => student.id === studentId)
    let thatStudentInstructorId = pullFullStudent.instructorId
    return instructors.find((instructor) => instructor.id === thatStudentInstructorId)
}
